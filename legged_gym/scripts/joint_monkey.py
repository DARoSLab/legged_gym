...
asset2_options = gymapi.AssetOptions()
asset2_options.fix_base_link = True
asset2_options.flip_visual_attachments = asset_descriptors[0].flip_visual_attachments
asset2_options.use_mesh_materials = True



print("Loading asset '%s' from '%s'" % (asset_file, asset_root))
asset = gym.load_asset(sim, asset_root, asset_file, asset_options)
asset2 = gym.load_asset(sim, asset_root, asset_descriptors[0].file_name, asset2_options)
...
dof_states2 = np.zeros(12, dtype=gymapi.DofState.dtype)
...
dof_positions2 = dof_states2['pos']
...
cam_target = gymapi.Vec3(0, 1.3, 0)
